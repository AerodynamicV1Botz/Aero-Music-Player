...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "Aero VC Player")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/AerodynamicV1Botz/Aero-Music-Player",
)
...
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/AerodynamicV1_Promotiob")
